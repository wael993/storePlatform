...
export const RoutePaths = {
	...
	CASH_BALANCE: withBasePath('/cash-balance'),
...
export const fullPaths = {
	...
	CASH_BALANCE: RoutePaths.CASH_BALANCE,
...
export const routeLabelKeys = {
	...
	CASH_BALANCE: 'components.pageHeaders.cashBalance',
...
export const getRouteLabel = (path: string, fallback = '') => {
	const routeLabelKeyByPath: Record<string, string> = {
		...
		[RoutePaths.CASH_BALANCE]: routeLabelKeys.CASH_BALANCE,
...
export const generateBreadcrumbs = (params?: BreadcrumbParams) => {
	...
	const cashBalance: BreadcrumbItem[] = [
		{
			id: 'store-platform',
			name: t(routeLabelKeys.STORE_PLATFORM),
			href: fullPaths.ROOT,
		...
		{
			id: 'cash-balance',
			name: t(routeLabelKeys.CASH_BALANCE),
			href: fullPaths.CASH_BALANCE,
			isCurrentPage: true,
		},
	]
