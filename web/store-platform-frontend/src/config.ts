...
export const config = {
	...
	actionsEnabled: splitByComma(
		import.meta.env.VITE_ACTIONS_ENABLED ??
			'PRODUCTS,ADD_NEW_TENANT,TENANTS_LIST,DAILY,CUSTOMERS,CATEGORIES,SUPPLIERS,PARTNERS,SETTINGS,USERS,EMPLOYEES,BARCODE,SELLING_INVOICES,INVOICE_AI,INVOICE,REPORTS,CHANGE_PASSWORD,SETTINGS,ORDERS',
	),
