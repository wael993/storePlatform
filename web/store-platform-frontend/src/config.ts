...
export const config = {
	...
	actionsEnabled: splitByComma(
		import.meta.env.VITE_ACTIONS_ENABLED ??
			'PRODUCTS,ADD_NEW_TENANT,TENANTS_LIST,DAILY,CUSTOMERS,CATEGORIES,SUPPLIERS,PARTNERS,SETTINGS,USERS,EMPLOYEES,SELLING_INVOICES,INVOICE_AI,REPORTS,CHANGE_PASSWORD,ORDERS',
	),
