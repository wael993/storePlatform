...
const API_SEGMENT_TO_PAGES: Record<string, TenantAccessiblePage[]> = {
	...
	invoices: [TENANT_ACCESSIBLE_PAGE.SELLING_INVOICES],
	'selling-invoices': [TENANT_ACCESSIBLE_PAGE.SELLING_INVOICES],
	'buying-invoices': [TENANT_ACCESSIBLE_PAGE.SELLING_INVOICES],
	inventory: [
	...
	'role-permissions': [TENANT_ACCESSIBLE_PAGE.USERS],
	expenses: [
		TENANT_ACCESSIBLE_PAGE.DAILY,
		TENANT_ACCESSIBLE_PAGE.SELLING_INVOICES,
	],
	...
	employees: [TENANT_ACCESSIBLE_PAGE.EMPLOYEES],
	tenants: [
